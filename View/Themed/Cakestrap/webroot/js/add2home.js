...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			...
			cs_cz: 'Pro instalaci aplikace na Váš %device, stisknete %icon a v nabídce <strong>Pridat na plochu</strong>.',
			...
			hu_hu: 'Telepítse ezt a web-alkalmazást az Ön %device-jára: nyomjon a %icon-ra majd a <strong>Foképernyohöz adás</strong> gombra.',
			...
			tr_tr: 'Bu uygulamayi %device\'a eklemek için %icon simgesine sonrasinda <strong>Ana Ekrana Ekle</strong> dügmesine basin.',
