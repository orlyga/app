...
//orly added - if user and password are coming as a login request - then what does it have to do with the cookie??? bug!!
		
		if ((isset($request->data['User']['username'])) && (isset($request->data['User']['password']))) {
			return false;
