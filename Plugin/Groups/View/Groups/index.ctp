<div class="groups index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('term_sub_id');?></th>
	...
	<tr>
		...
		<td><?php echo h($group['Group']['term_id']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['term_sub_id']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['contact_id']); ?>&nbsp;</td>
